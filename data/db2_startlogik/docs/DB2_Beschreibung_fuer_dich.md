...
## Festgezogene Besetzungsregel der Startelf
- Die Startformation eines Vereins wird zuerst mit positionspassenden Startspielern vorbereitet.
- Startslots dürfen nur durch Hauptposition oder passende Nebenposition besetzt werden.
- Positionsfremde Spieler dürfen keine Startslots absichern.
- Bank und Reserve werden erst aus den verbleibenden Kaderspielern gebildet.


## Anschluss an DB6 und DB7
Beim Erzeugen eines neuen Karrierestands wird ein leerer `db6`-Block mit Matchhistorie und ein leerer `db7`-Block für die Spielsimulation initialisiert.
Die laufende Befüllung von DB6 und die eigentliche Matchberechnung in DB7 gehören nicht mehr zu DB2, sondern zu späterer Spiel-/Simulationslogik.
