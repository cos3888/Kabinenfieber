...
check('Game build and remote contract are independent',
  app.includes("var KF_VERSION = '0.29.3';")&&
...
check('Server separates service build from API contract',
  server.includes("const SERVICE_VERSION = '0.29.3';")&&
...
check('Production cache busting is current',
  index.includes('KF_0.29.3')&&
  index.includes('app.bundle.js?v=0.29.3')&&
  index.includes('app.css?v=0.29.3'));
