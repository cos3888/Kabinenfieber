...
check('Runtime enthaelt weiterhin den KF_0.25.2-Fix',JSON.parse(read('package.json')).version==='0.27.3'&&read('src/app.bundle.js').includes('KF0252_SIM_TICK_BUDGET_MS'),{runtimeVersion:JSON.parse(read('package.json')).version});
