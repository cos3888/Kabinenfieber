...
check('Runtime version is consistently KF_0.29.1',pkg.version==='0.29.1'&&index.includes('KF_0.29.1')&&app.includes("var KF_VERSION = '0.29.1';"),{package:pkg.version});
...
check('World schema remains KF_0.27.2 while app is KF_0.29.1',app.includes("world.meta.schemaVersion='kf-core-0.27.2'"),{});
