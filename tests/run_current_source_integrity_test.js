...
check('Runtime version is consistently KF_0.27.2',pkg.version==='0.27.2'&&index.includes('KF_0.27.2')&&app.includes("var KF_VERSION = '0.27.2';"),{package:pkg.version});
...
check('World schema is KF_0.27.2 with external finance ledger',app.includes("world.meta.schemaVersion='kf-core-0.27.2'"),{});
