...
check('Runtime is KF_0.29.2 while cleanup schema remains 0.27.2',app.includes("var KF_VERSION = '0.29.2';")&&app.includes("world.meta.schemaVersion='kf-core-0.27.2'")&&app.includes("record.schemaVersion='kf-world-record-0.27.2'"),{});
