...
check('KF_0.25.6 Sponsorfix bleibt unter KF_0.29.2 aktiv',code.includes("var KF_VERSION = '0.29.2';")&&read('index.html').includes('KF_0.29.2')&&JSON.parse(read('package.json')).version==='0.29.2',{});
