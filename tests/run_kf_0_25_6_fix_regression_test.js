...
check('KF_0.25.6 Sponsorfix bleibt unter KF_0.26.2 aktiv',code.includes("var KF_VERSION = '0.27.2';")&&read('index.html').includes('KF_0.27.2')&&JSON.parse(read('package.json')).version==='0.27.2',{});
