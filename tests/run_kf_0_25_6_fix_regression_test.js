...
check('KF_0.25.6 Sponsorfix bleibt unter KF_0.29.1 aktiv',code.includes("var KF_VERSION = '0.29.1';")&&read('index.html').includes('KF_0.29.1')&&JSON.parse(read('package.json')).version==='0.29.1',{});
