...
code=code.replace(/\n  if \(document\.readyState === 'loading'\) \{/,`\n  window.KFTest={AppState,startNewCareer,advanceCareerRound,nextCalendarSlot,WorldRepository,CurrentSeasonMatchRepository,CurrentSeasonFinanceRepository,renderMatchInfoModalBody};\n  if (document.readyState === 'loading') {`);
...
check('Career initializes as KF_0.27.0',String((w.meta||{}).schemaVersion)==='kf-core-0.27.2',{schema:(w.meta||{}).schemaVersion,initMs});
