...
check('Runtime enthaelt den KF_0.25.5-Fix und laeuft aktuell als KF_0.26.2',code.includes("var KF_VERSION = '0.27.2';")&&read('index.html').includes('KF_0.27.2')&&JSON.parse(read('package.json')).version==='0.27.2',{});
