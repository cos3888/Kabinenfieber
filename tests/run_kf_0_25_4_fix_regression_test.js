...
check('Runtime enthaelt den KF_0.25.4-Fix und laeuft aktuell als KF_0.26.2',read('src/app.bundle.js').includes("var KF_VERSION = '0.27.3';")&&read('index.html').includes('KF_0.27.3')&&JSON.parse(read('package.json')).version==='0.27.3',{});
