...
check('Runtime enthaelt den KF_0.25.4-Fix unter KF_0.29.1',read('src/app.bundle.js').includes("var KF_VERSION = '0.29.1';")&&read('index.html').includes('KF_0.29.1')&&JSON.parse(read('package.json')).version==='0.29.1',{});
