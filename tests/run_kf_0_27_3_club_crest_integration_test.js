...
const passed=db.clubs.length===432&&sizes.length===424&&JSON.stringify(missing.sort())===JSON.stringify(expectedMissing)&&badDimensions.length===0&&notPng.length===0&&app.includes("var KF_VERSION = '0.29.1';");
